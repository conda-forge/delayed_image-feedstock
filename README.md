...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/delayed_image-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/delayed_image-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add delayed_image
# for installing globally
pixi global install delayed_image
```
...
It is possible to list all of the versions of `delayed_image` available on your platform:
...
```
pixi search delayed_image --channel conda-forge
```
